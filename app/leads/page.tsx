...
  async function updateStatus(id: number | string | undefined, status: string) {
    if (!id) return;
...
        keyword === ''
          ? true
          : `${lead.customer_name} ${lead.phone} ${lead.service_address || lead.city || ''} ${lead.service_type} ${lead.customer_notes} ${lead.source || ''} ${lead.quote_amount || ''} ${lead.appointment_date || ''} ${lead.follow_up_notes || ''}`
              .toLowerCase()
              .includes(keyword);
...
                <p><strong>Service Address:</strong> {lead.service_address || lead.city || ''}</p>
...
                <p><strong>Quote Amount:</strong> {lead.quote_amount || ''}</p>
                <p><strong>Appointment Date:</strong> {lead.appointment_date || ''}</p>
                <p><strong>Follow-up Notes:</strong> {lead.follow_up_notes || ''}</p>
