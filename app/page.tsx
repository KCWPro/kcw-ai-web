...
                  <a
                    href={item.href}
                    className="mt-2 block text-base font-semibold text-slate-900 hover:text-blue-700"
                  >
                    {item.value}
                  </a>
                ) : (
...
            {advantages.map((item) => (
              <article key={item.title} className="flex gap-3 rounded-xl bg-slate-50 p-4">
...
        <section className="mt-12 rounded-3xl border border-blue-200 bg-gradient-to-r from-blue-900 to-slate-900 px-6 py-10 text-white shadow-xl md:px-10">
          <h2 className="text-3xl font-semibold tracking-tight">
            Ready to start your project?
          </h2>
          <p className="mt-2 text-blue-100">Call 626-503-7777 today</p>
          <a
            href="tel:6265037777"
            className="mt-6 inline-flex items-center justify-center rounded-xl bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-100"
          >
            Call Now
          </a>
        </section>
...
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-6 py-8 text-sm text-slate-600 md:flex-row md:flex-wrap md:items-center md:justify-between md:gap-4">
...
            626-503-7777
          </a>
          <a href="mailto:kcwpro7777@gmail.com" className="hover:text-blue-700">
