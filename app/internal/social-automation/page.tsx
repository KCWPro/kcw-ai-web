    ...
    <main className="px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="rounded-2xl bg-white p-6 shadow-sm">
          <p className="text-xs uppercase tracking-[0.15em] text-slate-500">KCW Internal · Social Automation V1.5</p>
          ...
          <p className="mt-2 text-sm text-slate-600">Official OAuth only. No account-password automation. Non-public-ready platforms are always downgraded to manual/draft/private flow.</p>
        </header>
