...
function run() {
  ...
  assert.match(readyReadinessHtml, /Scope-prep hardening is documentation\/contract-only and never implementation prewire/);
  assert.match(readyReadinessHtml, /Boundary revalidation hardening never opens skeleton runtime rollout/);
  ...
  assert.match(readyReadinessHtml, /boundary revalidation != skeleton runtime activation/);
  ...
  assert.match(readyReadinessHtml, /Boundary revalidation hardening never opens skeleton runtime activation\./);
