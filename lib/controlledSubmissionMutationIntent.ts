...
export const CONTROLLED_SUBMISSION_MUTATION_INTENT_LIFECYCLE_BOUNDARY_NOTICE_LINES = [
  ...
  "Adjudication-level skeleton carrying never opens runtime carrying, rollout, or activation.",
  "Candidate-B scope lock is boundary-only and never unlocks runtime capabilities.",
