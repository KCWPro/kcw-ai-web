...
export const CONTROLLED_SUBMISSION_MUTATION_INTENT_PHASE28_STEP2_MINIMAL_NARROW_ACTIVE_RUNTIME_CONTINUITY_HARDENING_SUMMARY =
  Object.freeze({
    scope: "candidate_a_single_object_phase28_step2_minimal_narrow_active_runtime_continuity_hardening_only",
    boundary_equations: [
      ACTIVE_RUNTIME_CANDIDATE_IS_NOT_GENERALIZED_CAPABILITY_ROLLOUT_ACTIVE_CLAUSE,
      ACTIVE_RUNTIME_CANDIDATE_IS_NOT_GENERALIZED_CAPABILITY_ACTIVATION_ACTIVE_CLAUSE,
      ACTIVE_RUNTIME_CANDIDATE_IS_NOT_EXECUTION_UNLOCK_CLAUSE,
...
export function getControlledSubmissionMutationIntentPhase28Step2MinimalNarrowActiveRuntimeContinuityHardeningSummary() {
  return CONTROLLED_SUBMISSION_MUTATION_INTENT_PHASE28_STEP2_MINIMAL_NARROW_ACTIVE_RUNTIME_CONTINUITY_HARDENING_SUMMARY;
}
